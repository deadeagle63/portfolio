...
function Contact() {
  ...
  return (
    <m.div id='contact' className='min-w-full w-screen h-full min-h-screen overflow-scroll bg-gradient-to-r to-zinc-700 from-slate-700 snap-center shrink-0 flex flex-col gap-4 px-8 pb-16 md:py-0 no-scrollbar' ref={inViewRef}>
      <m.div className='flex flex-col py-8 items-center justify-center gap-2' >
        <m.h2 className='text-white text-7xl font-bold text-center' initial={animateIn.initial} whileInView={{ ...animateIn.whileInView,transition:{delay:0.33} }} viewport={{ once: true, amount: 0.25 }}>Contact</m.h2>
      ...
      <m.div className='flex flex-col gap-4 mb-24 mt-8 md:mb-0  items-center'>
        <m.p className='text-white font-bold text-4xl ' initial={animateIn.initial} whileInView={{ ...animateIn.whileInView, transition: { delay: 0.33 } }} viewport={{ once: true, amount: 0.45 }}>
          Socials
        </m.p>
        <m.div className='flex flex-row  sm:flex-nowrap gap-8' initial={animateIn.initial} whileInView={{ ...animateIn.whileInView, transition: { delay: 0.33 } }} viewport={{ once: true, amount: 0.33 }}>
