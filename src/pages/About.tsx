...
function About() {
  ...
  return (
    <m.div id='about' className='min-w-full w-screen h-full min-h-screen overflow-scroll bg-gradient-to-l to-stone-900 from-stone-800 snap-center shrink-0 gap-4 px-8 py-8 md:py-4 lg:py-0 no-scrollbar' ref={inViewRef} >
      <m.div className='flex justify-center py-8 flex-col items-center gap-2' >
        ...
        <m.span className='flex flex-col gap-2 items-center justify-center relative w-full' initial={animateIn.initial} whileInView={{ ...animateIn.whileInView, transition: { delay: 0.55 } }} viewport={{ once: true, amount: 0.25 }}>
