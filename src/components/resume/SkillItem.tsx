...
const SkillItem = ({ skill, level }: { skill: string, level: number }) => {
  return <m.div  className='flex flex-col gap-4 justify-between px-2 md:px-6 py-4 rounded-xl bg-gray-700 border-2 border-white border-opacity-70 md:min-w-[180px] max-w-[280px]  cursor-pointer hover:scale-110 flex-shrink '
